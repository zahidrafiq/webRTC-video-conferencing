...
(function(n, t) {
    ...
    i.version = "0.9.0", i.protocol = 1, i.transports = [], i.j = [], i.sockets = {}, i.connect = function(n, r) {
        var u = i.util.parseUri(n),
            o, f, e;
        return t && t.location && (u.protocol = u.protocol || t.location.protocol.slice(0, -1), u.host = u.host || (t.document ? t.document.domain : t.location.hostname), u.port = u.port || t.location.port), o = i.util.uniqueUri(u), e = { host: u.host, secure: "https" == u.protocol, port: u.port || ("https" == u.protocol ? 443 : 80), query: u.query || "" }, i.util.merge(e, r), (e["force new connection"] || !i.sockets[o]) && (f = new i.Socket(e)), !e["force new connection"] && f && (i.sockets[o] = f), f = f || i.sockets[o], f.of(u.path.length > 1 ? u.path : "")
    }
    ...
    i.parseUri = function(n) {
    ...
    }, i.chunkQuery = function(n) { for (var u = {}, r = n.split("&"), i = 0, f = r.length, t; i < f; ++i) t = r[i].split("="), t[0] && (u[t[0]] = t[1]); return u }, r = !1, i.load = function(n) {
        if ("document" in t && document.readyState === "complete" || r) return n();
        i.on(t, "load", n, !1)
    }, i.on = function(n, t, i, r) { n.attachEvent ? n.attachEvent("on" + t, i) : n.addEventListener && n.addEventListener(t, i, r) }, i.request = function(n) {
        ...
        if (!n) try { return new ActiveXObject("Microsoft.XMLHTTP") } catch (t) {}
        return null
    }, "undefined" != typeof window && i.load(function() { r = !0 }), i.defer = function(n) {
        if (!i.ua.webkit || "undefined" != typeof importScripts) return n();
        i.load(function() { setTimeout(n, 100) })
        ...
        if (this.$events && this.$events[n]) {
            ...
            if (t.util.isArray(r)) {
                for (f = -1, u = 0, e = r.length; u < e; u++)
                    if (r[u] === i || r[u].listener && r[u].listener === i) { f = u; break }
                if (f < 0) return this;
                r.splice(f, 1), r.length || delete this.$events[n]
            } else(r === i || r.listener && r.listener === i) && delete this.$events[n]
        }
        return this
    }, i.prototype.removeAllListeners = function(n) { return this.$events && this.$events[n] && (this.$events[n] = null), this }, i.prototype.listeners = function(n) { return this.$events || (this.$events = {}), this.$events[n] || (this.$events[n] = []), t.util.isArray(this.$events[n]) || (this.$events[n] = [this.$events[n]]), this.$events[n] }, i.prototype.emit = function(n) {
        var i, f, u, r, e;
    ...
    function a(n) { return isFinite(n.valueOf()) ? n.getUTCFullYear() + "-" + u(n.getUTCMonth() + 1) + "-" + u(n.getUTCDate()) + "T" + u(n.getUTCHours()) + ":" + u(n.getUTCMinutes()) + ":" + u(n.getUTCSeconds()) + "Z" : null }

    function s(n) { return h.lastIndex = 0, h.test(n) ? '"' + n.replace(h, function(n) { var t = l[n]; return typeof t == "string" ? t : "\\u" + ("0000" + n.charCodeAt(0).toString(16)).slice(-4) }) + '"' : '"' + n + '"' }
    ...
    function e(n, t) {
        ...
        switch (typeof u) {
            ...
            case "object":
                if (!u) return "null";
                i += f, o = [];
                if (Object.prototype.toString.apply(u) === "[object Array]") { for (v = u.length, h = 0; h < v; h += 1) o[h] = e(h, u) || "null"; return c = o.length === 0 ? "[]" : i ? "[\n" + i + o.join(",\n" + i) + "\n" + y + "]" : "[" + o.join(",") + "]", i = y, c }
    ...
    o.stringify = function(n, t, u) {
        ...
        var i;
        n = String(n), c.lastIndex = 0, c.test(n) && (n = n.replace(c, function(n) { return "\\u" + ("0000" + n.charCodeAt(0).toString(16)).slice(-4) }));
    ...
    i.encodePacket = function(n) {
        ...
        switch (t.type) {
            ...
            case "message":
                ...
                break;
            case "event":
                try { u = r.parse(n), t.name = u.name, t.args = u.args } catch (c) {}
                t.args = t.args || [];
                break;
            case "json":
                try { t.data = r.parse(n) } catch (c) {}
                break;
            case "connect":
                t.qs = n || "";
                break;
            case "ack":
                i = n.match(/^([0-9]+)(\+)?(.*)/);
                if (i) { t.ackId = i[1], t.args = []; if (i[3]) try { t.args = i[3] ? r.parse(i[3]) : [] } catch (c) {} }
        }
        return t
    }, i.decodePayload = function(n) { var u, t, r; if (n.charAt(0) == "\ufffd") { for (u = [], t = 1, r = ""; t < n.length; t++) n.charAt(t) == "\ufffd" ? (u.push(i.decodePacket(n.substr(t + 1).substr(0, r))), t += Number(r) + 1, r = "") : r += n.charAt(t); return u } return [i.decodePacket(n)] }
})("undefined" != typeof io ? io : module.exports, "undefined" != typeof io ? io : module.parent.exports), (function(n, t) {
    function i(n, t) { this.socket = n, this.sessid = t }
    ...
    n.Socket = r, t.util.mixin(r, t.EventEmitter), r.prototype.of = function(n) { return this.namespaces[n] || (this.namespaces[n] = new t.SocketNamespace(this, n), n !== "" && this.namespaces[n].packet({ type: "connect" })), this.namespaces[n] }, r.prototype.publish = function() {
        ...
        var o = this,
            ...
            e, r, i;
        this.isXDomain() && !t.util.ua.hasCORS ? (e = document.getElementsByTagName("script")[0], r = document.createElement("script"), r.src = h + "&jsonp=" + t.j.length, e.parentNode.insertBefore(r, e), t.j.push(function(n) { s(n), r.parentNode.removeChild(r) })) : (i = t.util.request(), i.open("GET", h, !0), i.withCredentials = !0, i.onreadystatechange = function() { i.readyState == 4 && (i.onreadystatechange = u, i.status == 200 ? s(i.responseText) : !o.reconnecting && o.onError(i.responseText)) }, i.send(null))
        ...
        return this.handshake(function(r, u, f, e) {
            ...
            i.once("connect", function() { clearTimeout(i.connectTimeoutTimer), n && typeof n == "function" && n() })
        }), this
    }, r.prototype.packet = function(n) { return this.connected && !this.doBuffer ? this.transport.packet(n) : this.buffer.push(n), this }, r.prototype.setBuffer = function(n) { this.doBuffer = n, !n && this.connected && this.buffer.length && (this.transport.payload(this.buffer), this.buffer = []) }, r.prototype.disconnect = function() {
        if (this.connected) {
        ...
        i.open("GET", n, !0);
        this.onDisconnect("booted")
    }, r.prototype.isXDomain = function() { var n = i.location.port || ("https:" == i.location.protocol ? 443 : 80); return this.options.host !== i.location.hostname || this.options.port != n }, r.prototype.onConnect = function() { this.connected || (this.connected = !0, this.connecting = !1, this.doBuffer || this.setBuffer(!1), this.emit("connect")) }, r.prototype.onOpen = function() { this.open = !0 }, r.prototype.onClose = function() { this.open = !1 }, r.prototype.onPacket = function(n) { this.of(n.endpoint).onPacket(n) }, r.prototype.onError = function(n) { n && n.advice && this.options.reconnect && n.advice === "reconnect" && this.connected && (this.disconnect(), this.reconnect()), this.publish("error", n && n.reason ? n.reason : n) }, r.prototype.onDisconnect = function(n) {
    ...
    function i(n, t) { this.socket = n, this.name = t || "", this.flags = {}, this.json = new r(this, "json"), this.ackPackets = 0, this.acks = {} }

    function r(n, t) { this.namespace = n, this.name = t }
    n.SocketNamespace = i, t.util.mixin(i, t.EventEmitter), i.prototype.$emit = t.EventEmitter.prototype.emit, i.prototype.of = function() { return this.socket.of.apply(this.socket, arguments) }, i.prototype.packet = function(n) { return n.endpoint = this.name, this.socket.packet(n), this.flags = {}, this }, i.prototype.send = function(n, t) { var i = { type: this.flags.json ? "json" : "message", data: n }; return "function" == typeof t && (i.id = ++this.ackPackets, i.ack = !0, this.acks[i.id] = t), this.packet(i) }, i.prototype.emit = function(n) {
    ...
    }, i.prototype.disconnect = function() { return this.name === "" ? this.socket.disconnect() : (this.packet({ type: "disconnect" }), this.$emit("disconnect")), this }, i.prototype.onPacket = function(n) {
        function r() { u.packet({ type: "ack", args: t.util.toArray(arguments), ackId: n.id }) }
        var u = this,
            i;
        switch (n.type) {
            case "connect":
            ...
            case "message":
            case "json":
                i = ["message", n.data], n.ack == "data" ? i.push(r) : n.ack && this.packet({ type: "ack", ackId: n.id }), this.$emit.apply(this, i);
                break;
            case "event":
    ...
    }, r.prototype.send = function() { this.namespace.flags[this.name] = !0, this.namespace.send.apply(this.namespace, arguments) }, r.prototype.emit = function() { this.namespace.flags[this.name] = !0, this.namespace.emit.apply(this.namespace, arguments) }
})("undefined" != typeof io ? io : module.exports, "undefined" != typeof io ? io : module.parent.exports), (function(n, t, i) {
    function r() { t.Transport.apply(this, arguments) }
    ...
    n.flashsocket = i, t.util.inherit(i, t.Transport.websocket), i.prototype.name = "flashsocket", i.prototype.open = function() {
        ...
        t.util.load(u)
    }, i.check = function() { return typeof WebSocket == "undefined" || !("__initialize" in WebSocket) || !swfobject ? !1 : swfobject.getFlashPlayerVersion().major >= 10 }, i.xdomainCheck = function() { return !0 }, typeof window != "undefined" && (WEB_SOCKET_DISABLE_AUTO_INITIALIZATION = !0), t.transports.push("flashsocket")
})("undefined" != typeof io ? io.Transport : module.exports, "undefined" != typeof io ? io : module.parent.exports);
if ("undefined" != typeof window) var swfobject = function() {
    function v() { var i, r, n; if (c) return; try { i = t.getElementsByTagName("body")[0].appendChild(s("span")), i.parentNode.removeChild(i) } catch (u) { return } for (c = !0, r = b.length, n = 0; n < r; n++) b[n]() }

    function kt(n) { c ? n() : b[b.length] = n }
    ...
    function pt(n) {
        if (typeof r.addEventListener != i) r.addEventListener("load", n, !1);
            ...
            var u = r.onload;
            r.onload = function() { u(), n() }
        } else r.onload = n
    }

    function ni() { vt ? gt() : nt() }
    ...
    function gt() {
        ...
        e.setAttribute("type", p), r = o.appendChild(e), r ? (u = 0, (function() {
            ...
            } else if (u < 10) { u++, setTimeout(arguments.callee, 10); return }
    ...
    function ht(t) {
        var i = u(t);
        i && i.nodeName == "OBJECT" && (n.ie && n.win ? (i.style.display = "none", (function() { i.readyState == 4 ? ii(t) : setTimeout(arguments.callee, 10) })()) : i.parentNode.removeChild(i))
    }
    ...
    function u(n) { var i = null; try { i = t.getElementById(n) } catch (r) {} return i }

    function s(n) { return t.createElement(n) }

    function dt(n, t, i) { n.attachEvent(t, i), a[a.length] = [n, t, i] }
    ...
    var i = "undefined",
        ...
        n = function() {
            ...
            else if (typeof r.ActiveXObject != i) try { c = new ActiveXObject(ti), c && (n = c.GetVariable("$version"), n && (h = !0, n = n.split(" ")[1].split(","), u = [parseInt(n[0], 10), parseInt(n[1], 10), parseInt(n[2], 10)])) } catch (w) {}
            return { w3: a, pv: u, wk: v, ie: h, win: l, mac: y }
        }(),
        ei = function() {
            if (!n.w3) return;
            (typeof t.readyState != i && t.readyState == "complete" || typeof t.readyState == i && (t.getElementsByTagName("body")[0] || t.body)) && v(), c || (typeof t.addEventListener != i && t.addEventListener("DOMContentLoaded", v, !1), n.ie && n.win && (t.attachEvent(yt, function() { t.readyState == "complete" && (t.detachEvent(yt, arguments.callee), v()) }), r == top && (function() {
                if (c) return;
                try { t.documentElement.doScroll("left") } catch (n) { setTimeout(arguments.callee, 0); return }
                v()
            })()), n.wk && (function() {
                if (c) return;
                if (!/loaded|complete/.test(t.readyState)) { setTimeout(arguments.callee, 0); return }
                v()
            })(), pt(v))
        }(),
        fi = function() {
    ...
    return {
        ...
        getObjectById: function(t) { if (n.w3) return it(t) },
        embedSWF: function(t, r, u, e, o, s, h, c, a, v) {
            ...
            n.w3 && !(n.wk && n.wk < 312) && t && r && u && e && o ? (l(r, !1), kt(function() {
                ...
                if (g(o)) d = rt(n, p, r), n.id == r && l(r, !0), y.success = !0, y.ref = d;
                    ...
                    if (s && tt()) { n.data = s, et(n, p, r, v); return }
                    l(r, !0)
                }
                v && v(y)
            })) : v && v(y)
        },
        switchOffAutoHideShow: function() { bt = !1 },
        ua: n,
        getFlashPlayerVersion: function() { return { major: n.pv[0], minor: n.pv[1], release: n.pv[2] } },
        hasFlashPlayerVersion: g,
        createSWF: function(t, i, r) { return n.w3 ? rt(t, i, r) : undefined },
        showExpressInstall: function(t, i, r, u) { n.w3 && tt() && et(t, i, r, u) },
        removeSWF: function(t) { n.w3 && ht(t) },
        createCSS: function(t, i, r, u) { n.w3 && wt(t, i, r, u) },
        addDomLoadEvent: kt,
        addLoadEvent: pt,
...
(function() {
    ...
    if (!swfobject.hasFlashPlayerVersion("10.0.0")) { n.error("Flash Player >= 10.0.0 is required."); return }
    location.protocol == "file:" && n.error("WARNING: web-socket-js doesn't work in file:///... URL unless you set Flash Security Settings properly. Open the page via Web server i.e. http://..."), WebSocket = function(n, t, i, r, u) {
        var f = this;
        f.__id = WebSocket.__nextId++, WebSocket.__instances[f.__id] = f, f.readyState = WebSocket.CONNECTING, f.bufferedAmount = 0, f.__events = {}, t ? typeof t == "string" && (t = [t]) : t = [], setTimeout(function() { WebSocket.__addTask(function() { WebSocket.__flash.create(f.__id, n, t, i || null, r || 0, u || null) }) }, 0)
    }, WebSocket.prototype.send = function(n) { if (this.readyState == WebSocket.CONNECTING) throw "INVALID_STATE_ERR: Web Socket connection has not been established"; var t = WebSocket.__flash.send(this.__id, encodeURIComponent(n)); return t < 0 ? !0 : (this.bufferedAmount += t, !1) }, WebSocket.prototype.close = function() {
    ...
    }, WebSocket.prototype.addEventListener = function(n, t) { n in this.__events || (this.__events[n] = []), this.__events[n].push(t) }, WebSocket.prototype.removeEventListener = function(n, t) {
        var u, r;
        if (!(n in this.__events)) return;
        for (u = this.__events[n], r = u.length - 1; r >= 0; --r)
            if (u[r] === t) { u.splice(r, 1); break }
    ...
    function u() {}
    n.XHR = r, t.util.inherit(r, t.Transport), r.prototype.open = function() { return this.socket.setBuffer(!1), this.onOpen(), this.get(), this.setCloseTimeout(), this }, r.prototype.payload = function(n) {
        for (var u = [], i = 0, r = n.length; i < r; i++) u.push(t.parser.encodePacket(n[i]));
        this.send(t.parser.encodePayload(u))
    }, r.prototype.send = function(n) { return this.post(n), this }, r.prototype.post = function(n) {
        function f() { this.readyState == 4 && (this.onreadystatechange = u, t.posting = !1, this.status == 200 ? t.socket.setBuffer(!1) : t.onClose()) }

        function r() { this.onload = u, t.socket.setBuffer(!1) }
        var t = this;
    ...
    }, r.prototype.close = function() { return this.onClose(), this }, r.prototype.request = function(n) {
        ...
        if (n == "POST") try { i.setRequestHeader ? i.setRequestHeader("Content-type", "text/plain;charset=UTF-8") : i.contentType = "text/plain" } catch (u) {}
        return i
    }, r.prototype.scheme = function() { return this.socket.options.secure ? "https" : "http" }, r.check = function(n, i) { try { if (t.util.request(i)) return !0 } catch (r) {} return !1 }, r.xdomainCheck = function() { return r.check(null, !0) }
})("undefined" != typeof io ? io.Transport : module.exports, "undefined" != typeof io ? io : module.parent.exports, this), (function(n, t) {
    function i() { t.Transport.XHR.apply(this, arguments) }
    n.htmlfile = i, t.util.inherit(i, t.Transport.XHR), i.prototype.name = "htmlfile", i.prototype.get = function() {
        ...
        t.util.on(window, "unload", function() { r.destroy() })
    ...
    }, i.prototype.close = function() { return this.destroy(), t.Transport.XHR.prototype.close.call(this) }, i.check = function() {
        if (typeof window != "undefined" && "ActiveXObject" in window) try { var n = new ActiveXObject("htmlfile"); return n && t.Transport.XHR.check() } catch (i) {}
        return !1
    }, i.xdomainCheck = function() { return !1 }, t.transports.push("htmlfile")
    ...
    function u() {}
    n["xhr-polling"] = r, t.util.inherit(r, t.Transport.XHR), t.util.merge(r, t.Transport.XHR), r.prototype.name = "xhr-polling", r.prototype.open = function() { var n = this; return t.Transport.XHR.prototype.open.call(n), !1 }, r.prototype.get = function() {
        function f() {
        ...
        if (this.xhr) {
            ...
            try { this.xhr.abort() } catch (n) {}
            this.xhr = null
        }
    }, r.prototype.ready = function(n, i) {
        var r = this;
        t.util.defer(function() { i.call(r) })
    ...
    n["jsonp-polling"] = r, t.util.inherit(r, t.Transport["xhr-polling"]), r.prototype.name = "jsonp-polling", r.prototype.post = function(n) {
        function o() { e(), r.socket.setBuffer(!1) }

        function e() {
            r.iframe && r.form.removeChild(r.iframe);
            try { u = document.createElement('<iframe name="' + r.iframeId + '">') } catch (n) { u = document.createElement("iframe"), u.name = r.iframeId }
        ...
        this.iframe.attachEvent ? u.onreadystatechange = function() { r.iframe.readyState == "complete" && o() } : this.iframe.onload = o, this.socket.setBuffer(!0)
    }, r.prototype.get = function() {
        var r = this,
            n = document.createElement("script"),
            f = t.util.query(this.socket.options.query, "t=" + +new Date + "&i=" + this.index),
            i;
        this.script && (this.script.parentNode.removeChild(this.script), this.script = null), n.async = !0, n.src = this.prepareUrl() + f, n.onerror = function() { r.onClose() }, i = document.getElementsByTagName("script")[0], i.parentNode.insertBefore(n, i), this.script = n, u && setTimeout(function() {
            var n = document.createElement("iframe");
            document.body.appendChild(n), document.body.removeChild(n)
        }, 100)
    }, r.prototype._ = function(n) { this.onData(n); return this.open && this.get(), this }, r.prototype.ready = function(n, i) {
        var r = this;
        if (!u) return i.call(this);
        t.util.load(function() { i.call(r) })
    }, r.check = function() { return "document" in i }, r.xdomainCheck = function() { return !0 }, t.transports.push("jsonp-polling")
